package com.bishe.core.kaptcha.impl;
...
/**
 * {@link NoWaterRipple} adds water ripple effect to an image.
 */
public class NoWaterRipple extends Configurable implements GimpyEngine
{
	...
	public BufferedImage getDistortedImage(BufferedImage baseImage)
	{
		...
		Graphics2D graphics = (Graphics2D) distortedImage.getGraphics();
		 ...
		 rippleFilter.filter(baseImage, null);

		 
		/*
		 * 去除水纹效果
		 * WaterFilter waterFilter = new WaterFilter();
		 * waterFilter.setAmplitude(1.5f); waterFilter.setPhase(10);
