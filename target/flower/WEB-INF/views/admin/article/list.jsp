...
<div id="dcWrap">
    ...
    <div id="dcMain">
	   	<!-- 当前位置 -->
		<div id="urHere">公告管理<b>></b><strong>公告列表</strong></div>
		<div class="mainBox" style="height:auto!important;">
			<form id="pageQueryForm" action="${ctx}/article/list" method="post">
				...
				<table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
					...
					<c:forEach items="${page.data }" var="pp">
						<tr>
							...
							<td>${pp.title }</td>
							<td>${pp.outline }</td>
							<td align="center">${pp.pubTime }</td>
							<td align="center">
								<a href="${ctx}/article/edit/${pp.id}">编辑</a> | <a href="${ctx}/article/remove/${pp.id}">删除</a>
							</td>
						</tr>
					</c:forEach>
				</table>
